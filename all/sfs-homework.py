...
parser.add_option('-i', '--numInodes',   default=10,     help='number of inodes in file system',      action='store', type='int', dest='numInodes') 
parser.add_option('-d', '--numData',     default=10,     help='number of data blocks in file system', action='store', type='int', dest='numData') 
