...
```
 ...
 ```
>首先需要对GDT进行初始化,完成段机制，因为段机制是页机制的前提。然后需要完成物理内存的分配，初始化相关控制寄存器如CR0,CR1等，进一步建立好页表，页目录表。
...
>加入asm volatile ("int $19")后，qemu进入中断，不像未加入该语句那样加载完后进行外设的捕捉，之所以有这样的差异，是因为"int $17"是一条系统调用的语句，会进入系统调用的debug模式。
...
va 0xc7ed4d57,pa 0x7311d57,pde_idx 0x31f,pde_ctx 0x20003,pte_idx 0x2d4,pte_ctx 0x7313
va 0xca6cecc0,pa 0xc9e9cc0,pde_idx 0x329,pde_ctx 0x2a003,pte_idx 0x2ce,pte_ctx 0xc9eb
va 0xc18072e8,pa 0x7412e8,pde_idx 0x306,pde_ctx 0x7003,pte_idx 0x7,pte_ctx 0x743
va 0xcd5f4b3a,pa 0x6ec9b3a,pde_idx 0x335,pde_ctx 0x36003,pte_idx 0x1f4,pte_ctx 0x6ecb
va 0xcc324c99,pa 0x8ac99,pde_idx 0x330,pde_ctx 0x31003,pte_idx 0x324,pte_ctx 0x8b
va 0xc7204e52,pa 0xb8b6e52,pde_idx 0x31c,pde_ctx 0x1d003,pte_idx 0x204,pte_ctx 0xb8b7
va 0xc3a90293,pa 0xf1fd293,pde_idx 0x30e,pde_ctx 0xf003,pte_idx 0x290,pte_ctx 0xf1ff
va 0xce6c3f32,pa 0x7d4f32,pde_idx 0x339,pde_ctx 0x3a003,pte_idx 0x2c3,pte_ctx 0x7d7
```
---
